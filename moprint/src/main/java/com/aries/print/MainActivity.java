...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///WifiPrintHelper.init("192.168.0.101",9100);
    }

    @Override
    protected void onResume() {
        super.onResume();
        ///WifiPrintHelper.getInstance().connect();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        ///WifiPrintHelper.getInstance().closeIOAndSocket();
    }
        ...
        if (view.getId() == R.id.btn_open_hp) {
            ...
            WifiPrinter.CrazyThreadPool.THREAD_POOL_EXECUTOR.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    String filePath = Environment.getExternalStorageDirectory() + File.separator + "table3.pdf";
